...
export default function AboutPage() {
  const team = [
    { name: "Christophe Verdouq", role: "CEO", img: "/team/Christophe.jpeg" },
    { name: "Josh Trivedi", role: "CTO", img: "/team/Josh-1.jpg" },
    ...
    <main className="min-h-screen bg-black text-white px-8 py-20">
      ...
      <section className="mt-20 max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 mb-6 text-lg leading-relaxed">
          PreDeeption empowers operators, integrators, and energy solution
          providers to manage fleets of batteries—whether in electric vehicles,
          e-bikes, or renewable energy storage systems (BESS)—with unmatched
          precision and foresight. By combining the power of Generative AI and
          Agentic AI, our platform delivers advanced battery analytics that go
          far beyond conventional monitoring. From real-time diagnostics to
          long-term forecasting and early anomaly detection, PreDeeption
          transforms raw data into smart, scalable decisions across the entire
          battery lifecycle.
        </p>
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {team.map((member) => (
            <div key={member.name} className="text-center">
              ...
              <h3 className="mt-4 font-semibold text-yellow-400">
                {member.name}
              </h3>
